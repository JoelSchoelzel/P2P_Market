...
def calc_characs(nodes, options, par_rh, opti_res: dict=None, start_step: int = None, length: int = 4):
    """
    ...
    for n in range(options["nb_bes"]):
        ...
        for n_opt in result_steps:
            ...
            energy_forced = 0 # energy that the TES can be charged with
            ...
            energy_delayed = 0  # energy that the TES can be discharged by
            i = 0  # variable to iterate through hours, represents whole hours
