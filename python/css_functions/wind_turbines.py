...
def powerCurve(wind_turbine_model):
    ...
    try:
        ...
        data_folder = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "css_functions")
        power_curve_path = os.path.join(data_folder, wind_turbine_model + ".csv")
...
def wind_turbine_generation(array_windSpeed, wind_turbine_model):
    """
